...
public class TermWindow extends Window {
  ...
  public final static int typeIndexID = JCasRegistry.register(TermWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TermWindow() {/* intentionally empty block */}
   ...
   */
  public TermWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TermWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
