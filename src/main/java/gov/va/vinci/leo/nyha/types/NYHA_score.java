 ...
 * @generated */
public class NYHA_score extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NYHA_score.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NYHA_score() {/* intentionally empty block */}
   ...
   */
  public NYHA_score(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public NYHA_score(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
