 ...
 * @generated */
public class TermPattern extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(TermPattern.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TermPattern() {/* intentionally empty block */}
   ...
   */
  public TermPattern(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TermPattern(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
