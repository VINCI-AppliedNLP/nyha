...
public class NyhaClient {
	...
	public static void main(String[] args) throws CmdLineException {
		if (args.length < 3) {
			new NyhaClient(new File("config/ClientConfig.groovy"),
					//new File("config/readers/FileCollectionReaderConfig.groovy"),
			...
			NyhaClient bean = new NyhaClient();
	...
	public NyhaClient(File clientConfigFile, File readerConfig, File[] listenerConfigFiles) {
	...
	public static void printUsage() {
		CmdLineParser parser = new CmdLineParser(new NyhaClient());
		System.out.print("Usage: java " + NyhaClient.class.getCanonicalName());
