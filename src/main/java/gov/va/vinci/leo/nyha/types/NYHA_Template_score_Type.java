...
public class NYHA_Template_score_Type extends RegularExpressionType_Type {
  ...
  public final static int typeIndexID = NYHA_Template_score.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.leo.nyha.types.NYHA_Template_score");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public NYHA_Template_score_Type(JCas jcas, Type casType) {
    super(jcas, casType);
