 ...
 * @generated */
public class CHF_Term extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(CHF_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CHF_Term() {/* intentionally empty block */}
   ...
   */
  public CHF_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CHF_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
