...
public class TermContext_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.leo.nyha.types.TermContext");
  ...
  public String getExperiencer(int addr) {
      ...
      jcas.throwFeatMissing("Experiencer", "gov.va.vinci.leo.nyha.types.TermContext");
  ...
  public String getExperiencerPattern(int addr) {
      ...
      jcas.throwFeatMissing("ExperiencerPattern", "gov.va.vinci.leo.nyha.types.TermContext");
  ...
  public String getNegation(int addr) {
      ...
      jcas.throwFeatMissing("Negation", "gov.va.vinci.leo.nyha.types.TermContext");
  ...
  public String getNegationPattern(int addr) {
      ...
      jcas.throwFeatMissing("NegationPattern", "gov.va.vinci.leo.nyha.types.TermContext");
  ...
  public String getTemporality(int addr) {
      ...
      jcas.throwFeatMissing("Temporality", "gov.va.vinci.leo.nyha.types.TermContext");
  ...
  public String getTemporalityPattern(int addr) {
      ...
      jcas.throwFeatMissing("TemporalityPattern", "gov.va.vinci.leo.nyha.types.TermContext");
  ...
  public int getWindow(int addr) {
      ...
      jcas.throwFeatMissing("Window", "gov.va.vinci.leo.nyha.types.TermContext");
