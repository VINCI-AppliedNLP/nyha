...
/**
 * Extracts annotation information, including feature data from the CAS for output into a map that supports row output.
 * <p>
 * Created by Olga Patterson on 3/24/2015.
 */
