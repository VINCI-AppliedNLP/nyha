...
public class NYHA_Template_score extends RegularExpressionType {
  ...
  public final static int typeIndexID = JCasRegistry.register(NYHA_Template_score.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NYHA_Template_score() {/* intentionally empty block */}
   ...
   */
  public NYHA_Template_score(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public NYHA_Template_score(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public NYHA_Template_score(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
