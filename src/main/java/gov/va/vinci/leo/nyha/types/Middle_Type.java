...
public class Middle_Type extends RegularExpressionType_Type {
  ...
  public final static int typeIndexID = Middle.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.leo.nyha.types.Middle");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Middle_Type(JCas jcas, Type casType) {
    super(jcas, casType);
